...
const projects = [
  { 
    title: "IGMMS Client", 
    description: "A simple GPS tracking application.", 
    url: "https://github.com/barigyederek/igmmsClient" 
  },
  { 
  ...
  },
  {
    ...
    description: "A Python script that intelligently copies and organizes media files (MP3, MP4, AVI, MOV, MKV, FLV, WAV, OGG) into structured folders by file type, creation date, or genre while preserving original files and metadata.",
    url: "https://github.com/barigyederek/organize_media_copy.py"
},
  {
